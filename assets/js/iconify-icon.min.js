...
!(function () {
  ...
  function Tt(t, e) {
    let n = Array.from(t.childNodes).find(
      (t) => t.hasAttribute && t.hasAttribute(It)
    );
    n ||
      ((n = document.createElement("style")),
      n.setAttribute(It, It),
      t.appendChild(n)),
      (n.textContent =
    ...
    if ("svg" === s)
      ...
      c = (function (t, e, n) {
        ...
        const r = t.attributes,
          s =
            'url("' +
            ((u = Ft(i, { ...r, width: e.width + "", height: e.height + "" })),
            "data:image/svg+xml," +
              (function (t) {
                return t
                  .replace(/"/g, "'")
  ...
  function Ut(t, e, n) {
    return {
      ...
      inline: e,
      icon: t,
      lastRender: n && (n.setting ? n : n.lastRender),
    };
  }
    ...
    const i = ["icon", "mode", "inline", "width", "height", "rotate", "flip"],
      r = class extends n {
        ...
        _iconChanged(t) {
          const e = mt(t, (t, e, n) => {
            const o = this._state;
            if (o.setting || this.getAttribute("icon") !== t) return;
            const i = { value: t, name: e, data: n };
            i.data ? this._gotIconData(i) : (o.icon = i);
          });
          e.data
            ? this._gotIconData(e)
            : (this._state = Ut(e, this._state.inline, this._state));
        }
        _gotIconData(t) {
          (this._checkQueued = !1),
        ...
        _renderIcon(t, e, n) {
          const o = (function (t, e) {
              ...
              return "style" === e || (!yt && -1 !== t.indexOf("<a"))
